...
class Planet {
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            PlanetEnum pl;
            if (planet < 8) {
                System.out.println("Планета: " + PlanetEnum.values()[planet].name());
                System.out.println("Сила притяжения: " + PlanetEnum.values()[planet].getForce() + " м/с^2");
